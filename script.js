...
.type("Assqlamualaikum", { delay: 300 })
  .move(-11)
  .delete(1)
  .type("a")
  .move(null, { to: "END" })
  ...
  .break({ delay: 500 })
  .break({ delay: 500 })
  .type("Saya Vkri Permana")
  .move(-11)
  .type("i")
  .move(null, { to: "END" })
  .type(" Dengan sepenuh hati mengucapkan")
  .pause(500)
  .break({ delay: 500 })
  .break({ delay: 500 })
  .type("<em>Selamat Ulang Tahun ^^</em>")
  .break({ delay: 500 })
  .break({ delay: 500 })
  .type("Semoga semua harapannya dapat terlaksanakan")
  .break({ delay: 500 })
  .break({ delay: 500 })
  .type("<em>- Vikri Permana , your bae</em>")
  .pause(500)
  .delete(3)
  .type("friend :)")
  .go();
